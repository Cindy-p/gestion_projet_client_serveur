...
public class GenerateurRequetes {
	...
	private String[] typesRequetes = { "A", "B", "C", "D", "E", "F", "G", "H",
			"I", "J", "K", "L", "M" };
				...
				if (lettreRequete.equals(typeRequete)) {
					if (typeRequete.equals("A")) {
						...
						if (st2.countTokens() == 3) {
							...
							req = "INSERT INTO tache VALUES ( null, '" + nom
									+ "', " + duree + ", " + projet + ")";
						...
						if (st2.countTokens() == 3) {
							...
							int duree = Integer.parseInt(st2.nextToken());
							int projet = Integer.parseInt(st2.nextToken());
							req = "UPDATE tache SET tache_nom = '" + nom
									+ "', tache_duree = " + duree
									+ ", projet_numero = " + projet
									+ " WHERE tache_numero = " + code;
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
						...
						if (infosRequete.length() == 1
								|| infosRequete.length() == 2) {
							int code = Integer.parseInt(infosRequete);
							req = "DELETE FROM tache WHERE tache_numero = "
									+ code;
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
						...
						if (st2.countTokens() == 1) {
							int code = Integer.parseInt(st2.nextToken());
							String nom = st2.nextToken();
							req = "UPDATE personne SET personne_nom = '" + nom
									+ "' WHERE personne_numero = " + code;
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
						...
						if (st2.countTokens() == 2) {
							int code = Integer.parseInt(st2.nextToken());
							String nom = st2.nextToken();
							req = "DELETE FROM personne WHERE personne_numero = "
									+ code
									+ " AND personne_nom = '"
									+ nom
									+ "'";
						...
						StringTokenizer st2 = new StringTokenizer(infosRequete,
								",");
						if (st2.countTokens() == 2) {
							int codePersonne = Integer
									.parseInt(st2.nextToken());
							int codeTache = Integer.parseInt(st2.nextToken());
							req = "INSERT INTO affectation VALUES ("
									+ codePersonne + ", " + codeTache + ")";
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
					...
					// A modifier
						...
						if (st2.countTokens() == 2) {
							int codePersonne = Integer
									.parseInt(st2.nextToken());
							int codeTache = Integer.parseInt(st2.nextToken());
							req = "UPDATE affectation SET tache_numero = "
									+ codeTache + " WHERE personne_numero = "
									+ codePersonne;
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
						...
						if (st2.countTokens() == 2) {
							int codePersonne = Integer
									.parseInt(st2.nextToken());
							int codeTache = Integer.parseInt(st2.nextToken());
							req = "DELETE FROM affectation WHERE personne_numero = "
									+ codePersonne
									+ " AND tache_numero = "
									+ codeTache;
							rep = executer.executerRequeteMAJ(req);
						...
						if (st2.countTokens() == 4) {
							int codePredecesseur = Integer.parseInt(st2
									.nextToken());
							int codeSuccesseur = Integer.parseInt(st2
									.nextToken());
							int delai = Integer.parseInt(st2.nextToken());
							int type = Integer.parseInt(st2.nextToken());
							req = "INSERT INTO contrainte VALUES ("
									+ codePredecesseur + ", " + codeSuccesseur
									+ ", " + delai + ", " + type + ")";
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
					...
					// A modifier
						...
						if (st2.countTokens() == 4) {
							...
							int delai = Integer.parseInt(st2.nextToken());
							int type = Integer.parseInt(st2.nextToken());
							req = "UPDATE contrainte SET tache_numero_successeur = "
									+ codeSuccesseur
									+ " AND delai = "
									+ delai
									+ " AND classe = "
									+ type
									+ " WHERE tache_numero_predecesseur = "
									+ codePredecesseur;
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
						...
						if (st2.countTokens() == 4) {
							...
							int delai = Integer.parseInt(st2.nextToken());
							int type = Integer.parseInt(st2.nextToken());
							req = "DELETE FROM contrainte WHERE tache_numero_successeur = "
									+ codeSuccesseur
									+ " AND delai = "
									+ delai
									+ " AND classe = "
									+ type
									+ " AND tache_numero_predecesseur = "
									+ codePredecesseur;
							rep = executer.executerRequeteMAJ(req);
							if (rep == true)
						...
						if (infosRequete.length() == 1) {
							...
							req = "SELECT * FROM projet WHERE projet_numero = "
									+ codeProjet;
